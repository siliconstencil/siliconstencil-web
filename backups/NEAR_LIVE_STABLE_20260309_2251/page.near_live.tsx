    ...
    <div className="slab-body" style={{
      ...
      <style jsx global>{`
        ...
        * { font-family: 'Share Tech Mono', monospace !important; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .core-container { 
          position: relative; width: 100%; display: flex; justify-content: center; align-items: center; z-index: 10;
          margin: 60px 0; /* Verified from Live DNA */
        }
        ...
        .typewriter { 
          ...
          border-right: 2px solid #FF4500; width: 0;
