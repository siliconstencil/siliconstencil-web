    ...
    <div style={styles.body}>
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        * { font-family: 'Share Tech Mono', monospace !important; margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @keyframes corePulse { 0%, 100% { transform: scale(0.95); box-shadow: 0 0 40px 5px rgba(255, 69, 0, 0.3); } 50% { transform: scale(1.05); box-shadow: 0 0 80px 20px rgba(255, 69, 0, 0.6); } }
      ...
      <div className="core-container">
        ...
        <div className="core"><div style={{ width: '40px', height: '40px', backgroundColor: '#fff', borderRadius: '50%', opacity: 0.2, filter: 'blur(8px)' }}></div></div>
      </div>
      <header style={{ position: 'relative', zIndex: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
        <div style={{ borderLeft: '2px solid #FF4500', paddingLeft: '16px' }}>
          <h1 style={{ fontSize: '32px', fontWeight: 'bold', letterSpacing: '0.2em', color: '#FF4500', textShadow: '0 0 10px rgba(255,69,0,0.8)' }}>SLAB</h1>
      ...
      <main style={{ position: 'relative', zIndex: 20, textAlign: 'center', marginTop: '30vh' }}>
        ...
        <div style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)', padding: '8px 16px', border: '1px solid rgba(255, 69, 0, 0.3)', backdropFilter: 'blur(4px)', display: 'inline-block' }}>
      ...
      <footer style={{ position: 'relative', zIndex: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', borderBottom: '1px solid #18181b', paddingBottom: '8px' }}>
        <div style={{ fontSize: '10px', color: '#3f3f46', textTransform: 'uppercase' }}><p>Encryption: SSS_LOG_3.2.0</p></div>
        <div style={{ fontSize: '10px', color: '#FF4500', textTransform: 'uppercase', fontWeight: 'bold' }} className="blink"><p>Awaiting Access Key</p></div>
      </footer>
    </div>
  );
}