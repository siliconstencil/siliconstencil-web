  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-6 relative selection:bg-[#FF4500] selection:text-black overflow-hidden bg-[#09090b] text-[#a1a1aa]">
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .brutalist-box { box-shadow: 8px 8px 0px 0px rgba(255, 69, 0, 0.2); transition: all 0.2s ease; }
      ...
      <main className="z-10 w-full max-w-4xl flex flex-col gap-8">
        <header className="border-b-4 border-zinc-800 pb-4 flex justify-between items-end glitch-load" style={{ animationDelay: '0.2s' }}>
          <div>
            <h1 className="text-3xl md:text-5xl font-extrabold text-white uppercase tracking-tighter">Silicon Stencil<br />Studios</h1>
            <p className="text-xs md:text-sm mt-2 tracking-widest uppercase">Monolith Infrastructure // v4.0</p>
          </div>
          <div className="text-right hidden md:block">
            <p className="text-xs text-zinc-600">SYS.LOC: SECTOR 0</p>
            <p className="text-xs text-zinc-600">AUTH: DIRECTOR_CD</p>
          </div>
        </header>
