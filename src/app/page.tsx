      ...
      <main className="z-10 w-full max-w-4xl flex flex-col gap-8">
        <header className="border-b-4 border-zinc-800 pb-4 flex justify-between items-end">
          <div>
            ...
            <p className="text-xs md:text-sm mt-2 tracking-widest uppercase text-zinc-600 font-bold italic">Monolith Infrastructure // v4.0</p>
          </div>
          <div className="text-right hidden md:block text-[10px] md:text-xs text-zinc-800 uppercase leading-tight font-bold">
            <p>Loc: Sector 0</p>
            <p>Auth: Root</p>
          </div>
        </header>
        <section className="border-4 border-zinc-800 p-8 brutalist-box bg-black relative">
        ...
        <footer className="flex flex-col md:flex-row justify-between items-center text-[10px] text-zinc-800 uppercase font-bold">
          ...
          <p className="text-soul-orange font-bold tracking-widest border-b border-soul-orange/20">SILICON STENCIL STUDIOS</p>
        </footer>
      </main>
    </div>
  )
